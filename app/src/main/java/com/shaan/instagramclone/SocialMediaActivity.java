...
public class SocialMediaActivity extends AppCompatActivity {
    ...
    @Override
    //my_menu menu from xml is integrated to SocialMediaActivity
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.my_menu, menu);
        return super.onCreateOptionsMenu(menu);
    }
    //Working with the options of menu item when clicked
            ...
            try{
                ...
                parseObject.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if(e==null){
                            FancyToast.makeText(SocialMediaActivity.this, "Upload successful...", Toast.LENGTH_LONG, FancyToast.SUCCESS,true).show();
                        }
                        else{
                            FancyToast.makeText(SocialMediaActivity.this,e.getMessage(), Toast.LENGTH_LONG, FancyToast.SUCCESS,true).show();
